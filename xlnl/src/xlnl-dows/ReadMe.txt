================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : xlnl-dows プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した xlnl-dows には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには xlnl-dows アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
xlnl-dows.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CxlnldowsApp アプリケーション クラス
    の宣言をします。

xlnl-dows.cpp
    このファイルは CxlnldowsApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\xlnldows.ico
    ...
    リソース ファイル xlnl-dows.rc によってインクルードされます。
...
res\Toolbar.bmp
    ...
    編集し、xlnl-dows.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を変更してください。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) xlnl-dows.pch や既にコン 
